...
Final state: typecheck clean, **189 unit tests** across 20 files, build OK (precache 14 entries), **e2e 7/7**. Verified in a real browser at 375×812, not only in jsdom.
