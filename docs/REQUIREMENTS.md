...
- **FR-LOG-3** — Log food/intake. **Gram entry is the primary control**, with a serving/portion selector beside it; quick-add, recents and barcode remain first-class paths. Logged rows display the quantity **as entered** — grams when grams were typed, the portion label when a tier was tapped. *(Amended 2026-07-28. Previously: "Default path is approximate … gram-precision is optional depth, never the required path.")* **The evidence traded against this is [A/B]** — 5 RCTs, 4 of 5 equal weight outcomes with higher engagement in simplified arms ([abandonment.md](01-research/users/abandonment.md)) — and it is stronger than the evidence behind some guardrails that were kept. It was traded knowingly, on the grounds that this is a **retention** finding rather than a harm one: choosing familiarity over retention-optimisation is a product bet, where choosing it over a safety guard would not be. **Reversal trigger:** logging abandonment in real use; the retention evidence is the named reason to put tiers back in the primary position. Decision D-G3.2 in [superpowers/plans/2026-07-27-trackers-redesign.md](superpowers/plans/2026-07-27-trackers-redesign.md).
